...
at `https://q8tly.com/guide/best-restaurants-in-kuwait/`. **First best-of list.** 10 place cards (MizuMesa 2354 · Solange 4025 · Naranj 2239 · Cure 3807 · Off the Coal 4330 · Amiti Noura 3145 · Chef Pillai 2818 · Kiwa 1939 · Queens 4659 · Chops 5575) + one `[q8tly_map]` of all 10. Hero = reused attachment 5427. Rank Math title/description/focus keywords set. **AR twin 6309 live same day** at `/ar/guide/best-restaurants-in-kuwait/` (10 cards → `/ar/places/`, hreflang paired, indexable). Later: Western digits in H1/SEO title/meta + the 10 headings moved to «الاسم (Latin)» using Bader-supplied spellings (table + listing cards stay Latin). Handoff: `handoffs/2026-09-22-best-restaurants-list.md`.
