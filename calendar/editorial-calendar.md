...
|-------|-----------------------------|---------------------|----|----|--------|-------|
| **Bar Frès: How Kuwait's Parisian-Japanese Conveyor-Belt Restaurant Works** | spotlight | Restaurants / Casual Dining (was Fine Dining; switched 2026-09-23), Arraya Centre, Kuwait City (6443) | ✅ live **6589** | ✅ live **6591**, unfenced | 2026-09-23 | **DONE (EN+AR same day). PHOTOS TEMPORARY** (added 2026-09-23 on Bader's instruction: the 8 listing photos, portrait = D-180 owner override; 16:9 collage hero 6635 + 5 section photos; replace with the blogger's full-size originals or the restaurant's official photos). Bader's article verbatim + his edits: EN kids bullet → "Better for adults…"; AR listing/guide links → `/ar/`, invoice attribution → «في زيارة مدوّنة Q8tly بتاريخ ١٩ سبتمبر ٢٠٢٦» (body + FAQ). No Jabriya listing on the site (Pipeline P-285 records an unbuilt Jabriya branch; neither guide mentions it). Text links kept (no card). Twin built without the "+". FAQ schema owed (Builder). |
...
at `https://q8tly.com/guide/bar-fres-arraya-centre/`. Single-place guide about listing 6443 (retitled "Bar Frès" the same evening on Bader's instruction, slug `barfres` kept). Text links, no card, no map. **Photos TEMPORARY** (2026-09-23): hero = 16:9 collage (attachment 6635) of listing photos 02/06/01; one listing photo per section (6489/6494/6495/6491/6496); EN + Bader-approved AR alt text. Owner override of D-180 (portrait, <1200 px); replace with the blogger's full-size originals or the restaurant's official photos. The storefront is the blogger's own photo with people removed (allowed). Rank Math title/description/focus keywords set. **AR twin 6591 live same day** at `/ar/guide/bar-fres-arraya-centre/` (links → `/ar/places/مدينة-الكويت/barfres/` + `/ar/guide/best-restaurants-in-kuwait/`, hreflang paired, indexable). Handoff: `handoffs/2026-09-23-bar-fres-guide.md`.
